        ...
        <div class="row">
            <div class="col-xl-4 col-lg-12">
                <div class="widget widget-one">
                    <div class="widget-header height-300" style="background-image: url(vendor/assets/common/img/temp/photos/5.jpeg)">
                            ...
                            <div class="widget-body clearfix">
                                <div class="conversation-block min-height-250 max-height-250 custom-scroll">
                                    <div class="conversation-item">
                                        <div class="s1">
                                            <a class="avatar" href="javascript:void(0);">
                                                <img src="vendor/assets/common/img/temp/avatars/3.jpg" alt="Alternative text to the image" />
                                            </a>
                                        </div>
                                        <div class="s2">
                                    ...
                                    <div class="conversation-item you">
                                        <div class="s1">
                                            <a class="avatar" href="javascript:void(0);">
                                                <img src="vendor/assets/common/img/temp/avatars/4.jpg" alt="Alternative text to the image" />
                                            </a>
                                        </div>
                                        <div class="s2">
            ...
            <div class="col-xl-4 col-md-12">
                <div class="row">
                    <div class="col-xl-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="widget widget-seven background-info" style="background-image: url(vendor/assets/common/img/temp/photos/9.jpeg)">
